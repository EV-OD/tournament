  ...
  return (
    <Link to="/" className={`flex items-center gap-3 group ${className}`}>
      <div className="relative w-10 h-10">
        {/* Outer Glow on Hover */}
        <div className="absolute -inset-2 bg-brand-500/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        >
          <defs>
            <linearGradient id="ballGradient" x1="4" y1="4" x2="36" y2="36" gradientUnits="userSpaceOnUse">
          ...
          {/* The classic Pentagon in the center background */}
          <path 
          ...
          <path d="M20 10V2" stroke="white" strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M29.5 16.9L36 12" stroke="white" strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M29.5 28.1L36 32" stroke="white" strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M10.5 28.1L4 32" stroke="white" strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />
          <path d="M10.5 16.9L4 12" stroke="white" strokeWidth="1.5" strokeOpacity="0.2" strokeLinecap="round" />

          {/* Energy Bolt - Cutting through the ball */}
          {/* Designed to look like it's charging the ball */}
          <path 
      ...
      <div className="flex flex-col justify-center -space-y-1 select-none">
        <span className="font-extrabold text-2xl tracking-tight text-slate-900 dark:text-white leading-none font-sans transition-colors">
          Aayo<span className="text-brand-500">Khel</span>
        </span>
